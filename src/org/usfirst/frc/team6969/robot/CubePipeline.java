...
public class CubePipeline implements VisionPipeline {
	...
	private Mat cvScaleaddOutput = new Mat();
	...
	@Override	public void process(Mat source0) {
		...
		double[] hsvThresholdHue = {0.0, 71.7235494880546};
		double[] hsvThresholdSaturation = {80.26079136690649, 196.2542662116041};
		double[] hsvThresholdValue = {108.92535971223025, 255.0};
		...
		double[] rgbThresholdRed = {147.90917266187046, 222.36348122866895};
		double[] rgbThresholdGreen = {116.9514388489209, 204.95733788395904};
		double[] rgbThresholdBlue = {0.0, 113.57508532423208};
		...
		// Step CV_scaleAdd0:
		Mat cvScaleaddSrc1 = cvErode1Output;
		double cvScaleaddScale = 1.0;
		Mat cvScaleaddSrc2 = cvErode0Output;
		cvScaleadd(cvScaleaddSrc1, cvScaleaddScale, cvScaleaddSrc2, cvScaleaddOutput);

		// Step Find_Contours0:
		Mat findContoursInput = cvScaleaddOutput;
		...
		double[] filterContoursSolidity = {70.62146892655367, 100};
	...
	/**
	 * This method is a generated getter for the output of a CV_scaleAdd.
	 * @return Mat output from CV_scaleAdd.
	 */
	public Mat cvScaleaddOutput() {
		return cvScaleaddOutput;
	}
	...
	/**
	 * Adds two images where one is multiplied by a number.
	 * @param src1 first image.
	 * @param scale scale for the first image.
	 * @param src2 second image.
	 * @param dst output image
	 */
	private void cvScaleadd(Mat src1, double scale, Mat src2, Mat dst) {
		Core.scaleAdd(src1, scale, src2, dst);
	}
